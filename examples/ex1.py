...
def run_example():
    ...
    base_dir['output_filename'] = os.path.join(top_dir,'examples','ex1')
    base_dir['heating']['partition'] = 1.0
    base_dir['heating']['events'] = [{'event':{'rise_start':0.0,'rise_end':250.0,'decay_start':250.0,'decay_end':500.0,'magnitude':0.04}}]
    #print the file
    ...
    plt.savefig(os.path.join(os.path.dirname(os.path.realpath(__file__)),'ex1.png'))

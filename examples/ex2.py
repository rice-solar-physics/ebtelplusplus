...
def run_example():
    ...
    base_dir['output_filename'] = os.path.join(top_dir,'examples','ex2')
    base_dir['total_time'] = 10000.0
    base_dir['heating']['partition'] = 0.0
    #configure the individual events
    events = []
    for i in range(5):
        events.append({'event':{'rise_start':i*2000.0, 'rise_end':i*2000.0+100.0, 'decay_start':i*2000.0+100.0, 'decay_end':i*2000.0+200.0,'magnitude':np.random.uniform(0.001,0.1)}})

...
ebtel-2fl: ebtel-2fl_functions_loop.o ebtel-2fl_functions_param.o ebtel-2fl_functions_util.o ebtel-2fl_functions_solvers.o ebtel-2fl_main.o 
	$(CC) $(CFLAGS) ebtel-2fl_functions_loop.o ebtel-2fl_functions_param.o ebtel-2fl_functions_util.o ebtel-2fl_functions_solvers.o ebtel-2fl_main.o -o ebtel-2fl -lm
